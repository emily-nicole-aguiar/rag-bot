# Requisitos:
# pip install chromadb ollama pyodbc google-generativeai pandas python-dotenv sqlalchemy
...
#
# 5. EMBEDDINGS VIA OLLAMA: Agora usa o modelo tazarov/all-minilm-l6-v2-f32 localmente.
#
# ==============================================================================
...
# Função de embedding personalizada usando Ollama com o modelo específico
class OllamaEmbeddingFunction:
    def __init__(self, model_name="tazarov/all-minilm-l6-v2-f32"):
    ...
    def __call__(self, texts):
        ...
        embeddings = []
        for text in texts:
            if not text.strip():  # Evita prompts vazios
                # Retorna um vetor zero se o texto estiver vazio (dimensão 384 para compatibilidade)
...
# Inicializa com o modelo desejado
embedding_fn = OllamaEmbeddingFunction(model_name="tazarov/all-minilm-l6-v2-f32")
